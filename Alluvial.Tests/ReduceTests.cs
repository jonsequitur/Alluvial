...
//
//            var indexCatchup = StreamCatchup.Distribute<IDomainEvent, string>(updatedStreams, batchCount: 1);
...
//            indexCatchup.Subscribe<Projection<List<AccountOpened>, string>, IDomainEvent, string>(
//                async (p, events) =>
//                {
...
//                "Savings accounts",
//                async q => index.Value.SkipWhile(v => q.Cursor.HasCursorReached(v.CheckpointToken))
