...
namespace Alluvial
{
    ...
    /// <summary>
    /// Queries a downstream stream based on an item from an upstream stream during an <see cref="Stream.IntoMany{TUpstream,TDownstream,TUpstreamCursor}" /> operation.
    /// </summary>
    ...
    /// <summary>
    /// Queries a downstream stream based on an item from an upstream partitioned stream during an <see cref="Stream.IntoMany{TUpstream,TDownstream,TUpstreamCursor,TPartition}" /> operation.
    /// </summary>
    /// <typeparam name="TUpstream">The type of the upstream stream.</typeparam>
    /// <typeparam name="TDownstream">The type of the downstream stream.</typeparam>
    /// <typeparam name="TUpstreamCursor">The type of the upstream cursor.</typeparam>
